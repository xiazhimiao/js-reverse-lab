!(function () {
    ...
    function startRpc() {
        if (window.flag) {
            ...
            // 链接中group组的名称需自行指定
            var client = new SekiroClient("ws://127.0.0.1:5620/business-demo/register?group=my_rpc&clientId=" + guid());

            // 功能接口action的名称需自行指定
            client.registerAction("get_rpc", function (request, resolve, reject) {
